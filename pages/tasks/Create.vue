  ...
  <div class="min-h-screen flex bg-gray-50">
    <div class="max-w-md mx-auto">
      ...
      <div class="mx-5">
          ...
          <div v-if="step > 1">
            ...
            <div class="flex space-x-8 mt-3 pb-5">
              <RadioButton
                ...
                v-bind:class="
                  isClickedEasy ? 'bg-blue-70 border-none shadow-inner' : 'bg-white border-2 border-gray-70'
                "
              >
                Facile
              </RadioButton>
              <RadioButton
                ...
                v-bind:class="
                  isClickedMedium ? 'bg-yellow-70 border-none shadow-inner' : 'bg-white border-2 border-gray-70'
                "
              >
                Moyen
              </RadioButton>
              <RadioButton
                ...
                v-bind:class="
                  isClickedHard ? 'bg-orange-70 border-none shadow-inner' : 'bg-white border-2 border-gray-70'
                "
              >
                Difficile
              </RadioButton>
          ...
          <div v-if="step > 2">
            ...
            <div class="flex space-x-5 mt-3 pb-5">
              <RadioButton
                class="px-12"
                v-bind:class="
                  isClickedDaily ? 'bg-yellow-70 border-none shadow-inner' : 'bg-white border-2 border-gray-70'
                "
              ...
              <RadioButton
                class="px-12"
                v-bind:class="
                  isClickedWeekly ? 'bg-yellow-70 border-none shadow-inner' : 'bg-white border-2 border-gray-70'
                "
        ...
        <ButtonPrimary class="mt-14" disabled="true" id="createTask" @click="createTask"
