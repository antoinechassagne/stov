        ...
        <div class="mx-5">
          ...
          <div id="etape-2">
            ...
            <div class="flex space-x-8 mt-3">
              <RadioButton label="Facile" name="difficulty" class="px-8"/>
          ...
          <ButtonPrimary class="mt-14" disabled="true">Créer la tâche ménagère</ButtonPrimary>
        </div>
      </div>
    </div>
